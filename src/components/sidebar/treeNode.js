  ...
  if (hasChildren) {
    switch (items[0].label) {
      ...
      case 'asura-realm': // dungeons
        ...
        items[6] = { items:[], label: 'trial-road', title: 'Trial Road', url: '/dungeons/trial-road'};
        items[7] = { items:[], label: 'cave-of-endless-night', title: 'Endless Night', url: '/dungeons/cave-of-endless-night'};
        items[8] = { items:[], label: 'jaguars-hunting-forest', title: 'Jaguar\'s Forest', url: '/dungeons/jaguars-hunting-forest'};
        items[9] = { items:[], label: 'trap-zone', title: 'Trap Zone', url: '/dungeons/trap-zone'};
        items[10] = { items:[], label: 'banana-kingdom', title: 'Banana Kingdom', url: '/dungeons/banana-kingdom'};
        items[11] = { items:[], label: 'static-forest', title: 'Static Forest', url: '/dungeons/static-forest'};
        items[12] = { items:[], label: 'double-strike-cave', title: 'Double Strike', url: '/dungeons/double-strike-cave'};
        items[13] = { items:[], label: 'entrancing-lane', title: 'Entrancing Lane', url: '/dungeons/entrancing-lane'};
        items[14] = { items:[], label: 'bayside-monster-cave', title: 'Bayside Cave', url: '/dungeons/bayside-monster-cave'};
        items[15] = { items:[], label: 'ceiling-cave', title: 'Ceiling Cave', url: '/dungeons/ceiling-cave'};
