...
<div class="pageTopImage screenshot">
  <img src="../images/other/bana_powers.png"/>
</div>

# Overview

Bana Powers are special attacks and abilities used by Banana Prince.<br/>
They're learned by either getting hit by a thrown item, or getting hit by a monster's special attack.

Items that grant a Bana Power have a banana icon at the beginning of the item's description.<br/>※ The banana icon is only displayed once you've entered Banana Kingdom at least one time.

<div class="relativeImage smallScreenshot">
  <img src="../images/other/bana_power_item.png"/>
</div>

Up to 8 Bana Powers can be learned at a time, with 4 being assigned to daytime, and 4 for nighttime.<br/>Banana Prince can use multiple Bana Powers in 1 turn if applicable, in order from top to bottom.

Bana Powers can be locked to avoid being overwritten when a new one is learned.<br/>
...
<table class="abilityTable">
  ...
  <tr>
    <td>2 Tile Rock</td>
    <td>Porky</td>
    <td>Throws a Porky Rock at a target within a 2 tile radius. (20 damage)<br/>Only throws rocks at targets within view.</td>
  </tr>
  <tr>
    <td>4 Tile Rock</td>
    <td>Porko</td>
  ...
  <tr>
    <td>Reflection</td>
    <td>Foly (Red)</td>
    <td>Reflects direct attacks instead of taking damage after activating. (1 turn)<br/>Effective against Absorbiphants and Gyazas.</td>
  </tr>
  <tr>
    <td>Heal Counter</td>
    <td>Foly (Green)</td>
  ...
  <tr>
    ...
    <td>Foly (Purple)</td>
    <td>Inflicts a status condition on the monster after being hit by a direct attack.<br/>(Bound, Inaccurate, Confused, or Berserk)</td>
  </tr>
  <tr>
    <td>Novice Magic</td>
    <td>DJ Mage</td>
    <td>Fires a magic bullet at a monster lined up in a straight line.<br/>(Knockback, Warp)</td>
  </tr>
  <tr>
    <td>Fair Magic</td>
    <td>MC Mage</td>
    <td>Fires a magic bullet at a monster lined up in a straight line.<br/>(Transient, Confused, Blind, 20 damage)</td>
  </tr>
  <tr>
    <td>Expert Magic</td>
    <td>MC Wizard</td>
    <td>Fires a magic bullet at a monster lined up in a straight line.<br/>(Paralyzed, Decoy, Sealed, Berserk, Level-1)</td>
  </tr>
  <tr>
    <td>Master Magic</td>
    <td>MC Sorceror</td>
    <td>Fires a magic bullet at a monster lined up in a straight line.<br/>(Banana, Empathy, Reduce HP to 1/4, Level-3)</td>
  </tr>
  <tr>
    <td>Absorb Status</td>
    <td>Absorbiphant type</td>
    <td>Absorbs status conditions from a target in front. (Can't absorb from self)<br/>Won't absorb Shiren's status conditions if he only has positive ones.<br/>Boosts attack power and heals bruising by 1 stage.</td>
  </tr>
  <tr>
    <td>Floor Magnet</td>
    <td>Fearabbit type</td>
    <td>Attracts Shiren and a number of other creatures on the floor to self.<br/>Performs a direct attack against 1 creature after attracting.<br/>Won't use unless separated from Shiren.</td>
  </tr>
  <tr>
    <td>Zap Counter</td>
    <td>Zapdon</td>
  ...
  <tr>
    <td>Flash Counter</td>
    <td>Flashdon</td>
    <td>60 damage counter attack if hit by an attack after activating. (1 turn)<br/>Effective against Absorbiphants and Gyazas.</td>
  </tr>
  <tr>
    <td>Crash Counter</td>
    <td>Crashdon</td>
    <td>70 damage counter attack if hit by an attack after activating. (1 turn)<br/>Effective against Absorbiphants and Gyazas.</td>
  </tr>
  <tr>
    <td>Roar</td>
    <td>Maneater type</td>
  ...
  <tr>
    <td>Healing Light</td>
    <td>Herb, Otogiriso,<br/>Heal Grass,<br/>Life Grass</td>
    <td>Restores HP of allies in a 1 tile radius by 50 points.</td>
  </tr>
  <tr>
    <td>Restore Attack</td>
    <td>Strength Grass,<br/>Antidote Grass,<br/>Cleansing Bracelet</td>
    <td>Restores attack power of self and allies within a 1 tile radius.<br/>Shiren's strength will be restored.</td>
  </tr>
  <tr>
    <td>Clarity</td>
    <td>Calm Bracelet</td>
  ...
  <tr>
    <td>Frightener</td>
    <td>Fear Scroll,<br/>Fear Talisman</td>
...
This section provides recommendations for Bana Power sets.<br/>
