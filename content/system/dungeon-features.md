...
Hurry to the exit when a warning is displayed, and use an Escape Scroll if you can't make it in time.<br/>※ Eating Undo Grass doesn't prompt you to escape in this game.
